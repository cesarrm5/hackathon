 ...
 ******************************************************************************/
    ...
    adminAuth: {
        ...
        users: [{
            username: "admin",
            password: "$2y$08$h3xL6aNePVjuHax7vlQl2OxJZJ7m6PMHLlNIu6196xF.1mjfzPLWy",
            permissions: "*"
        }]
    },
    ...
    https: {
      key: require("fs").readFileSync('/data/cer_node/node-key.pem'),
      cert: require("fs").readFileSync('/data/cer_node/node-cert.pem')
    },
